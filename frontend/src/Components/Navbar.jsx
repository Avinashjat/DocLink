    ...
    <>
      <div className="flex justify-between  items-center text-sm py-4 mb-5 border-b border-b-gray-500">
        ...
        <div className=" flex  justify-center items-center gap-4">
          {token && userData ? (
            <div className="flex   items-center gap- cursor-pointer group relative">
              <img
            ...
            <button
              ...
              className="hidden bg-primary text-white md:block py-3 px-9 rounded-full  font-normal"
            >
              {" "}
              create account{" "}
            </button>
