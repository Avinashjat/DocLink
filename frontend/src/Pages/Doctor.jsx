            ...
            {filterDoc.map((item) => (
              ...
              >
                <div className="w-full h-64 overflow-hidden">
                  <img
                    className="w-full h-full object-cover object-top bg-blue-50"
                    src={item.image}
                    alt="doctor"
                  />
                </div>
                <div className="p-4">
                  <div
                    className={`flex items-center text-center gap-2 text-sm ${item.available ? " text-green-500" : "text-gray-500"}`}
                  >
                    <p
